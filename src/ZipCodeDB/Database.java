...
public class Database {
    ...
    public Zipcode getNorthern(int lat) {
        ...
        /*
         * Wanted to search line by line through the latitudes, keeping track of the variable highest,
         * that would represent the highest latitude out of any of the zipcodes. At the end, I wanted to return
         * the zipcode that was on the same line in the website as the highest latitude was.
         */

        for (Zipcode lat : this.codes) {
    ...
    /*
     * Define an interface named LatLngInterface for getNorthern
     */
